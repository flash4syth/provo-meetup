Code.load_file("my_reducer.exs", __DIR__)

ExUnit.start()
ExUnit.configure(trace: true)

defmodule MyReducerTest do
  use ExUnit.Case
  ...
  test "produces correct answer for (square of sums) - (sum of squares)" do
    assert SumSquareDifference.compute(1..100) === 25_164_150.0
  end

  @tag :skip
  test "produces correct answer for (square of sums) - (sum of squares) as integer" do
    assert SumSquareDifference.compute_as_integer(1..100) === 25_164_150
  end
